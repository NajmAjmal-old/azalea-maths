...
const hashUrl = 'https://api.github.com/repos/NajmAjmal/azalea-maths/git/refs/heads/sparx-v2';
const bundleUrl = 'https://raw.githubusercontent.com/NajmAjmal/azalea-maths/sparx-v2/builds/bundle.js';
